...
/** 审核状态:1-待审核；2-审核中；3-审核通过；4-审核不通过 */
public enum EnumAuditState {
	PENDING("1", "待审核"), //前一结点未审核
	VERIFYING("2", "审核中"), //前一结点已审核通过，当前节点进入审核人待审核列表
	PASS("3", "审核通过"),
	REFUSED("4", "审核不通过");
	...
	private EnumAuditState(String code, String msg) {
		this.code = code;
		this.msg = msg;
		this.display = true;
	}
	 ...
	 * @return 枚举对象
	 */
	public static EnumAuditState getEnumByCode(String code) {
		if (code == null) {
			return null;
		}
		for (EnumAuditState type : values()) {
