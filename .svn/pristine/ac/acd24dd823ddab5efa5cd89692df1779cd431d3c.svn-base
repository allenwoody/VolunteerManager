package com.allen.core.feature.orm.mybatis;
...
import com.allen.core.feature.orm.dialect.Dialect;
import com.allen.core.feature.orm.dialect.DialectFactory;
...
public class PaginationStatementHandlerInterceptor implements Interceptor {
    ...
    private static final DefaultReflectorFactory DEFAULT_ReflectorFactory_FACTORY = new DefaultReflectorFactory();
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        MetaObject metaStatementHandler = MetaObject.forObject(statementHandler, DEFAULT_OBJECT_FACTORY, DEFAULT_OBJECT_WRAPPER_FACTORY, DEFAULT_ReflectorFactory_FACTORY);
