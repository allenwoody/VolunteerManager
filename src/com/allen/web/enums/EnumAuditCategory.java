...
public enum EnumAuditCategory {
	...
	private EnumAuditCategory(String code, String msg) {
		this.code = code;
		this.msg = msg;
		this.display = true;
	}
	 ...
	 * @return 枚举对象
	 */
	public static EnumAuditCategory getEnumByCode(String code) {
		if (code == null) {
			return null;
		}
		for (EnumAuditCategory type : values()) {
