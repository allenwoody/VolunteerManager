...
public enum EnumCustomerType {
	SIGNED_CLIENT("1", "个人"), 
	PARTENER_CLIENT("2", "团体");

	private String code;
	private String msg;
	private boolean display;

	private EnumCustomerType(String code, String msg) {
		this.code = code;
		this.msg = msg;
		this.display = true;
	}
	 ...
	 * @return 枚举对象
	 */
	public static EnumCustomerType getEnumByCode(String code) {
		if (code == null) {
			return null;
		}
		for (EnumCustomerType type : values()) {
