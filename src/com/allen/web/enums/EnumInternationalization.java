...
/**
 * 
* @ClassName: EnumInternationalization 
* @Description: 国际化语种
* @author wenquan
* @date 2016年2月18日 上午9:53:47 
*
 */
public enum EnumInternationalization {
	CHINESE("zh", "中文"),
	ENGLISH("en", "English"),
	;
	...
	private EnumInternationalization(String code, String msg) {
		this.code = code;
		this.msg = msg;
		this.display = true;
	}
	 ...
	 * @return 枚举对象
	 */
	public static EnumInternationalization getEnumByCode(String code) {
		if (code == null) {
			return null;
		}
		for (EnumInternationalization type : values()) {
